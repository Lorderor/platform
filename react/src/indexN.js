...
import CreateAccount from "./components/auth/createAccount/CreateAccountForm.jsx";
import CreateAccountPage from "./pages/auth/createAccount/CreateAccount.jsx";
import LogInPage from "./pages/auth/login/Login.jsx";
import Logout from "./components/auth/createAccount/logout.component.js";
import "./components/auth/createAccount/loginAndSignup.css";
...
import DashPage from "./pages/dashboard/Dashboard.js";
...
let navItems = [
  { id: 1, link: "", imgSrc: dashboard, title: "Личный кабинет" },
  { id: 2, link: "", imgSrc: classes, title: "Классы" },
  { id: 3, link: "", imgSrc: scheduling, title: "Планирование" },
  { id: 4, link: "", imgSrc: community, title: "Сообщество" },
  { id: 5, link: "", imgSrc: mailbox, title: "Почтовый ящик" },
  { id: 6, link: "", imgSrc: achievements, title: "Достижения" },
  { id: 7, link: "", imgSrc: socialInitiatives, title: "Рекомендации" },
  { id: 8, link: "", imgSrc: settings, title: "Настройки" }
];
