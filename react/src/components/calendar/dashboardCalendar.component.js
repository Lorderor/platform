...
class DashboardCalendarComponent extends Component {
	...
	buildEvents(events) {
		...
		if (events != null) {
			...
			return (
				<button type="button" class="btn btn-secondary event-subheading text-left mt-1">Нет событий</button>
			)
		}
	}
	...
	render() {
		...
		return (
			<Card className="dashCardStyle overflow-auto">
				<Card.Body>
					<Card.Title className="classCardTitleStyle">Предстоящие События</Card.Title>
